...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/020_environment"><div class="card__link-hover"/>
</router-link>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#misc_pod_settings/030_labels.adoc.adoc" @click.native="this.scrollFix('#misc_pod_settings/030_labels.adoc.adoc')"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Labels</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/040_annotations"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Annotations</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/080_add_containers"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/070_add_volumes"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/050_configmap_volumes"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/060_secret_volumes"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/090_pod_scheduling"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/misc_pod_settings/100_resources"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
