...
<dd slot="desc"><p>Since version 12.2.1.4 Coherence has had functionality to expose a management API over REST.</p>
...
<div class="section">
<p>To deploy a <code>Coherence</code> resource with management over REST enabled and exposed on a port, the simples yaml
...
(see <router-link to="/expose_ports_and_services/020_container_ports">Exposing Ports</router-link> for details)</li>
</ul>
...
<div class="section">
<p>Now that a port is beng forwarded from localhost to a <code>Pod</code> in the cluster the Management over REST endpoints can be accessed.</p>
