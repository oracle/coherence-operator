...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#coherence_settings/020_build_application.adoc" @click.native="this.scrollFix('#coherence_settings/020_build_application.adoc')"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Build Application Images</span>
</v-card-title>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#coherence_settings/030_deploy_application.adoc" @click.native="this.scrollFix('#coherence_settings/030_deploy_application.adoc')"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/020_classpath"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#coherence_settings/040_application_main.adoc" @click.native="this.scrollFix('#coherence_settings/040_application_main.adoc')"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#coherence_settings/050_application_args.adoc" @click.native="this.scrollFix('#coherence_settings/050_application_args.adoc')"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Add Main Arguments</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Adding arguments to pass to the main class.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#coherence_settings/060_application_working_dir.adoc" @click.native="this.scrollFix('#coherence_settings/060_application_working_dir.adoc')"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
