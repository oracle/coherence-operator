...
<div class="section">
<p>This is a reference for the Coherence Operator API types.</p>
...
<tr>
<td class=""><code>additionalInitContainers</code></td>
<td class="">List of additional initialization containers to add to the deployment&#8217;s Pod. Init containers cannot be added or removed. More info: <a id="" title="" target="_blank" href="https://kubernetes.io/docs/concepts/workloads/pods/init-containers/">https://kubernetes.io/docs/concepts/workloads/pods/init-containers/</a></td>
...
<tr>
<td class=""><code>additionalContainers</code></td>
<td class="">List of additional containers to add to the deployment&#8217;s Pod. Containers cannot be added or removed.</td>
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.17/#container-v1-core">corev1.Container</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
see: <router-link to="/misc_pod_settings/020_configmap_volumes">Add ConfigMap Volumes</router-link></td>
...
see: <router-link to="/coherence_settings/010_overview">Coherence Configuration</router-link></p>
...
see: <router-link to="/coherence_settings/030_cache_config">Configure Cache Config File</router-link></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
...
see: <router-link to="/coherence_settings/040_override_file">Configure Operational Config File</router-link></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
...
see: <router-link to="/coherence_settings/050_storage_enabled">Configure Storage Enabled</router-link></td>
<td class=""><code>&#42;bool</code></td>
<td class="">false</td>
</tr>
<tr>
...
see: <router-link to="/coherence_settings/080_persistence">Configure Persistence</router-link></td>
...
see: <router-link to="/coherence_settings/060_log_level">Configure Coherence log level</router-link></td>
<td class=""><code>&#42;int32</code></td>
<td class="">false</td>
</tr>
<tr>
...
see: <router-link to="/management_and_diagnostics/010_overview">Management &amp; Diagnostics</router-link></td>
...
see: <router-link to="/coherence_settings/070_wka">Well Known Addressing</router-link></td>
<td class=""><code>&#42;bool</code></td>
<td class="">false</td>
</tr>
<tr>
...
see: <router-link to="/misc_pod_settings/020_configmap_volumes">Add ConfigMap Volumes</router-link></p>
...
<tr>
<td class=""><code>loggingConfig</code></td>
<td class="">The name of the Java Util Logging configuration file to use. This value should be the full path to the configuration file. This value is used to directly set the -Djava.util.logging.config.file System property. If not set a default configuration file injected by the Operator will be used.</td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
