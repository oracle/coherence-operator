...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#install/01_installation.adoc" @click.native="this.scrollFix('#install/01_installation.adoc')"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/coherence_settings/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/expose_ports_and_services/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/management_and_diagnostics/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
