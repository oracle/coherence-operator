...
<div class="section">
<p>Whilst the Coherence Operator will run out of the box on OpenShift some versions of the Coherence Docker
image will not work without configuration changes.</p>

<p>Some earlier versions of the Coherence Docker images that Oracle publishes default to the container user
...
<p>and to annotate the Coherence containers, update the <code>CoherenceCluster</code> resource to include annotations</p>
...
spec:
  annotations:
    openshift.io/scc: anyuid  <span class="conum" data-value="1" />
  roles:
    - role: data
      replicas: 6</markup>
