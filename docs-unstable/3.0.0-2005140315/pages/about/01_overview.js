...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/install/01_installation"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-text class="caption">
<p></p>
<p>Coherence Operator Examples.</p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/clusters/010_introduction"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
