...
>  role:                      <span class="conum" data-value="1" />
  ...
  livenessProbe: {}          <span class="conum" data-value="20" />
  startQuorum: []            <span class="conum" data-value="21" /></markup>
...
Coherence containers.</li>
<li data-value="21">The <router-link to="/clusters/035_role_startup_ordering"><code>startQuorum</code></router-link> section configures the start-up dependencies for a role,
that is the roles that must be started before this role can start.</li>
</ul>
</div>
</doc-view>
