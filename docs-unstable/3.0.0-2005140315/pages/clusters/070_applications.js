...
<p>See the in-depth guide on <router-link to="/app-deployment/010_overview">Coherence application deployments</router-link> for more details on
...
<div class="admonition note">
<p class="admonition-inline">Note: When using a different main class, if you wish to ensure that Metrics and Management over REST services
are started correctly, you should include the following call before accessing any Coherence API&#8217;s -
   <code>DefaultCacheServer.startServerDaemon()</code>.</p>
</div>
