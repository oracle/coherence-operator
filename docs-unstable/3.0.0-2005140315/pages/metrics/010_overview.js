...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/metrics/040_scraping"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/metrics/045_importing"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Importing Dashboards</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Importing Grafana Dashboards into your own instance.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/metrics/050_dashboards"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Grafana Dashboards</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Details on the Grafana Dashboards available.</p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
