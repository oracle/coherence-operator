...
<li>
<router-link to="#install" @click.native="this.scrollFix('#install')">Install the Coherence Operator with Prometheus</router-link>

</li>
<li>
<router-link to="#install-coh" @click.native="this.scrollFix('#install-coh')">Install a Coherence Cluster with Metrics Enabled</router-link>

</li>
<li>
<router-link to="#prom" @click.native="this.scrollFix('#prom')">Access Prometheus</router-link>

</li>
<li>
<router-link to="#grafana" @click.native="this.scrollFix('#grafana')">Access Grafana</router-link>
<ol style="margin-left: 15px;">
<li>
<router-link to="#dashboards" @click.native="this.scrollFix('#dashboards')">Default Dashboards</router-link>

</li>
</ol>
</li>
<li>
<router-link to="#clean" @click.native="this.scrollFix('#clean')">Clean Up</router-link>

</li>
</ol>

<h3 id="install">1. Install the Coherence Operator with Prometheus</h3>
<div class="section">
...
<h3 id="install-coh">2. Install a Coherence Cluster with Metrics Enabled</h3>
<div class="section">
...
spec:
  ...
  coherence:
    metrics:
      ...
      port: 9612       <span class="conum" data-value="3" />
  ports:
    - name: metrics    <span class="conum" data-value="4" />
      port: 9612       <span class="conum" data-value="5" /></markup>
...
<li data-value="3">The <code>port</code> field sets the port that Coherence will use to expose metrics in the container.
The <code>port</code> field is is optional, the default port value is <code>9612</code>.</li>
<li data-value="4">The metrics port must be added to the additional <code>ports</code> list so that it is exposed on a service
to allow the default Prometheus <code>ServiceMonitor</code> installed by the operator to work; the port should be named <code>metrics</code>.</li>
<li data-value="5">The <code>port</code> field must be set to the same value as the <code>port</code> field in the <code>coherence.metrics</code> section or if no
<code>coherence.metrics.port</code> was specified it should be set to the default value of <code>9612</code></li>
</ul>
...
test-cluster-storage                    ClusterIP   None             &lt;none&gt;        30000/TCP   16m
...
<h3 id="prom">3. Access Prometheus</h3>
<div class="section">
...
<h3 id="grafana">3. Access Grafana</h3>
<div class="section">
...
<h4 id="dashboards">a. Default Dashboards</h4>
<div class="section">
<p>There are a number of dashboard created by default:</p>
