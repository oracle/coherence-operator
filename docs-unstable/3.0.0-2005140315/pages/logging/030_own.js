...
<h4 id="_elasticsearch_endpoint_host_port">Elasticsearch Endpoint Host &amp; Port</h4>
<div class="section">
...
--set elasticsearchEndpoint.port=your-es-port</markup>

</div>

<h4 id="_setting_the_elasticsearch_scheme">Setting the Elasticsearch Scheme</h4>
<div class="section">
<p>If your ElasticSearch server requires https then you must set the scheme value that will be applied to the fluentd configuration.
See: <a id="" title="" target="_blank" href="https://docs.fluentd.org/output/elasticsearch#scheme-optional">Fluend ES Config Docs</a></p>

<markup
lang="bash"

>--set elasticsearchEndpoint.scheme=https</markup>

<p>Valid values for <code>elasticsearchEndpoint.scheme</code> are http or <code>https</code> <strong>Note</strong> the scheme value is
case sensetive, fluentd will fail to start with any value other than exactly <code>http</code> or <code>https</code>.</p>

</div>

<h4 id="_multiple_elasticsearch_hosts">Multiple Elasticsearch Hosts</h4>
<div class="section">
<p>Instead of specifying host and port as described above you can use the <code>elasticsearchEndpoint.hosts</code>
value to specify one or more host strings as a comma delimited list.
See: <a id="" title="" target="_blank" href="https://docs.fluentd.org/output/elasticsearch#hosts-optional">Fluend ES Config Docs</a></p>
...
>--set elasticsearchEndpoint.hosts=https://customhost.com:443/path,https://username:password@host-failover.com:443</markup>

<p>If <code>elasticsearchEndpoint.hosts</code> is used then Fluentd will ignore any values set for <code>scheme</code> host` and <code>port</code>
as described in the <a id="" title="" target="_blank" href="https://docs.fluentd.org/output/elasticsearch#hosts-optional">Fluend ES Config Docs</a></p>

</div>

<h4 id="_elasticsearch_credentials">Elasticsearch Credentials</h4>
<div class="section">
