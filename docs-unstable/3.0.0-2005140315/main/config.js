...
function createRoutes(){
    return [
        ...
        },
        {
            ...
            component: loadPage('about-06_openshift', '/about/06_openshift', {})
        },
        {
        ...
        {
            path: '/app-deployment/040_scaling',
            meta: {
                h1: 'Scaling Roles',
                title: 'Scaling Roles',
                description: null,
            ...
            component: loadPage('app-deployment-040_scaling', '/app-deployment/040_scaling', {})
        },
        {
        ...
        {
            path: '/metrics/045_importing',
            meta: {
                h1: 'Importing Dashboards',
            ...
            component: loadPage('metrics-045_importing', '/metrics/045_importing', {})
        },
        {
        ...
        },
        {
            ...
            meta: {
                h1: 'Coherence Cluster K8s Resources',
                title: 'Coherence Cluster K8s Resources',
                description: null,
                keywords: null,
                customLayout: null,
                hasNav: true
        ...
        {
            path: '/clusters/035_role_startup_ordering',
            meta: {
                h1: 'Define Coherence Role Start Order',
                title: 'Define Coherence Role Start Order',
                description: null,
                keywords: null,
                customLayout: null,
                hasNav: true
            },
            component: loadPage('clusters-035_role_startup_ordering', '/clusters/035_role_startup_ordering', {})
        },
        {
    ...
    return [
        { header: 'Core documentation' },
        {
            ...
            items: [
                ...
                { href: '/about/06_openshift', title: 'Coherence Clusters on OpenShift' }
            ]
        },
        {
            title: 'Installation',
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/app-deployment/040_scaling', title: 'Scaling Roles' },
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/metrics/045_importing', title: 'Importing Dashboards' },
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/clusters/020_k8s_resources', title: 'Coherence Cluster K8s Resources' },
                { href: '/clusters/030_roles', title: 'Define Coherence Roles' },
                { href: '/clusters/035_role_startup_ordering', title: 'Define Coherence Role Start Order' },
