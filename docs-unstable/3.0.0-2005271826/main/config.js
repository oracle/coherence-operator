...
function createRoutes(){
    return [
        ...
        {
            path: '/jvm_settings/060_logging',
            meta: {
                h1: 'Java Util Logging',
            ...
            component: loadPage('jvm_settings-060_logging', '/jvm_settings/060_logging', {})
        },
        {
        ...
        {
            path: '/expose_ports_and_services/010_overview',
            meta: {
                h1: 'Overview',
                title: 'Overview',
                h1Prefix: null,
            ...
            component: loadPage('expose_ports_and_services-010_overview', '/expose_ports_and_services/010_overview', {})
        },
        {
            path: '/expose_ports_and_services/020_container_ports',
            meta: {
            ...
            component: loadPage('expose_ports_and_services-020_container_ports', '/expose_ports_and_services/020_container_ports', {})
        },
        {
            path: '/expose_ports_and_services/030_services',
            meta: {
            ...
            component: loadPage('expose_ports_and_services-030_services', '/expose_ports_and_services/030_services', {})
        },
        {
            path: '/expose_ports_and_services/040_servicemonitors',
            meta: {
            ...
            component: loadPage('expose_ports_and_services-040_servicemonitors', '/expose_ports_and_services/040_servicemonitors', {})
        },
        {
        ...
        {
            path: '/misc_pod_settings/020_configmap_volumes',
            meta: {
            ...
            component: loadPage('misc_pod_settings-020_configmap_volumes', '/misc_pod_settings/020_configmap_volumes', {})
        },
        {
            path: '/misc_pod_settings/030_secret_volumes',
            meta: {
            ...
            component: loadPage('misc_pod_settings-030_secret_volumes', '/misc_pod_settings/030_secret_volumes', {})
        },
        {
            path: '/misc_pod_settings/040_add_volumes',
            meta: {
                h1: 'Add Pod Volumes',
            ...
            component: loadPage('misc_pod_settings-040_add_volumes', '/misc_pod_settings/040_add_volumes', {})
        },
        {
            path: '/misc_pod_settings/050_add_containers',
            meta: {
                h1: 'Add Pod Containers',
                title: 'Add Pod Containers',
                h1Prefix: null,
                description: null,
                keywords: null,
                customLayout: null,
            ...
            component: loadPage('misc_pod_settings-050_add_containers', '/misc_pod_settings/050_add_containers', {})
        },
        {
    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/jvm_settings/060_logging', title: 'Java Util Logging' },
                { href: '/jvm_settings/070_debugger', title: 'Java Util Logging' },
        ...
        },
        {
            ...
            group: '/ports',
            items: [
                { href: '/expose_ports_and_services/010_overview', title: 'Overview' },
                { href: '/expose_ports_and_services/020_container_ports', title: 'Additional Container Ports' },
                { href: '/expose_ports_and_services/030_services', title: 'Configure Services for Ports' },
                { href: '/expose_ports_and_services/040_servicemonitors', title: 'Prometheus ServiceMonitors' }
            ]
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/misc_pod_settings/020_configmap_volumes', title: 'Add ConfigMap Volumes' },
                { href: '/misc_pod_settings/030_secret_volumes', title: 'Add Secrets Volumes' },
                { href: '/misc_pod_settings/040_add_volumes', title: 'Add Pod Volumes' },
                { href: '/misc_pod_settings/050_add_containers', title: 'Add Pod Containers' }
            ]
        },
        { divider: true },
