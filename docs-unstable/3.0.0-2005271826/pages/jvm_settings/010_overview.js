...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/030_jvm_args"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-card-text class="caption">
<p></p>
<p>Adding arbitrary JVM arguments.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/040_gc"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/050_memory"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Memory Settings</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/060_logging"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-card-text class="caption">
<p></p>
<p>Configuring Java util logging.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/070_debugger"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/080_jmx"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/jvm_settings/090_container_limits"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
