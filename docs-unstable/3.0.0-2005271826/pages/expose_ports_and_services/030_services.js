...
<div class="section">
<p>As described in the <router-link to="/expose_ports_and_services/020_container_ports">Additional Container Ports</router-link> documentation,
...
and the Kubernetes
<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#servicespec-v1-core">Service API reference</a>.</p>
