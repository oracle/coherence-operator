...
<ul class="ulist">
<li>
<p><router-link to="/expose_ports_and_services/030_services">Configure Services for Ports</router-link></p>

</li>
<li>
<p><router-link to="/expose_ports_and_services/040_servicemonitors">Prometheus ServiceMonitors</router-link></p>
...
(see the Kubernetes <a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#containerport-v1-core">ContainerPort</a> API reference).
...
<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#serviceport-v1-core">ServicePort</a> API reference.</p>
