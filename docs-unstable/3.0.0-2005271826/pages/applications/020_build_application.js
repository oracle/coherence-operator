...
for the Coherence container and from these constructs a Java comamnd line that it then executes.</p>
...
can be configured as described in the <router-link to="/jvm_settings/020_classpath">setting the classpath</router-link> documentation.</p>
...
<ul class="ulist">
<li>
<p>ConfigMaps - easily add a <code>ConfigMap</code> volume and volume mapping see: <router-link to="/misc_pod_settings/020_configmap_volumes">Add ConfigMap Volumes</router-link></p>

</li>
<li>
<p>Secrets - easily add a <code>Secret</code> volume and volume mapping see: <router-link to="/misc_pod_settings/030_secret_volumes">Add Secret Volumes</router-link></p>

</li>
<li>
<p>Volumes - easily add any additional volume and volume mapping see: <router-link to="/misc_pod_settings/040_add_volumes">Add Volumes</router-link></p>
