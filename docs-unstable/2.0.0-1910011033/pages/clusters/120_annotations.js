...
<v-card-text>
<dl>
<dt slot=title>Configure Pod Annotations</dt>
...
<h2 id="_configure_pod_annotations">Configure Pod Annotations</h2>
<div class="section">
...
the role then the annotation in the role will take precedence.</p>
