...
<div class="section">
<p>Ensure that the <router-link to="#install/02_prerequisites.adoc" @click.native="this.scrollFix('#install/02_prerequisites.adoc')">Coherence Operator prerequisites</router-link> are available.</p>
...
see <router-link to="#04_obtain_coherence_images.adoc" @click.native="this.scrollFix('#04_obtain_coherence_images.adoc')">Obtain Coherence Images</router-link></p>
