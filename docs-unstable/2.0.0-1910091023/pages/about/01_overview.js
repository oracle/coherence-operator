...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#about/04_quickstart.adoc" @click.native="this.scrollFix('#about/04_quickstart.adoc')"><div class="card__link-hover"/>
</router-link>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#install/01_introduction.adoc" @click.native="this.scrollFix('#install/01_introduction.adoc')"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/app-deployment/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Application Deployment</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">CoherenceCluster CRD Reference</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>In depth CoherenceCluster CRD reference documentation.</p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
