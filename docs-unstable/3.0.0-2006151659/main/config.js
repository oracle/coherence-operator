...
function createRoutes(){
    return [
        ...
        {
            path: '/management_and_diagnostics/100_tmb_test',
            meta: {
            ...
            component: loadPage('management_and_diagnostics-100_tmb_test', '/management_and_diagnostics/100_tmb_test', {})
        },
        {
    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/management_and_diagnostics/100_tmb_test', title: 'Coherence Network Testing' }
            ]
        },
        {
            title: 'Metrics',
