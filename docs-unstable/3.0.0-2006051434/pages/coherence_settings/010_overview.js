...
<v-card-text>
<dl>
<dt slot=title>Configuring Coherence</dt>
...
Any other settings can be configured by adding system properties to the <router-link to="#jvm_settings010_overview.adoc" @click.native="this.scrollFix('#jvm_settings010_overview.adoc')">JVM Settings</router-link>.</p>

<p>The following Coherence features can be directly specified in the <code>Coherence</code> spec.</p>

<ul class="ulist">
<li>
<p><router-link to="/coherence_settings/020_cluster_name">Cluster Name</router-link></p>

</li>
<li>
<p><router-link to="/coherence_settings/030_cache_config">Cache Configuration File</router-link></p>

</li>
<li>
<p><router-link to="/coherence_settings/040_override_file">Operational Configuration File</router-link> (aka, the override file)</p>

</li>
<li>
<p><router-link to="/coherence_settings/050_storage_enabled">Storage Enabled</router-link> or disabled deployments</p>

</li>
<li>
<p><router-link to="#coherence_settings/060_log_level" @click.native="this.scrollFix('#coherence_settings/060_log_level')">Log Level</router-link></p>

</li>
<li>
<p><router-link to="/coherence_settings/070_wka">Well Known Addressing</router-link> and cluster discovery</p>

</li>
<li>
<p><router-link to="/coherence_settings/080_persistence">Persistence</router-link></p>

</li>
<li>
<p><router-link to="/management_and_diagnostics/010_overview">Management over REST</router-link></p>
