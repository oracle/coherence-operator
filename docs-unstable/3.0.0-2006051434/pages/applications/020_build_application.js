...
<ul class="ulist">
<li>
<p>ConfigMaps - easily add a <code>ConfigMap</code> volume and volume mapping see: <router-link to="/misc_pod_settings/050_configmap_volumes">Add ConfigMap Volumes</router-link></p>

</li>
<li>
<p>Secrets - easily add a <code>Secret</code> volume and volume mapping see: <router-link to="/misc_pod_settings/060_secret_volumes">Add Secret Volumes</router-link></p>

</li>
<li>
<p>Volumes - easily add any additional volume and volume mapping see: <router-link to="/misc_pod_settings/070_add_volumes">Add Volumes</router-link></p>
