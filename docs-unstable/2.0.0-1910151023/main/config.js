...
function createRoutes(){
    return [
        ...
        {
            path: '/management/020_manegement_over_rest',
            meta: {
            ...
            component: loadPage('management-020_manegement_over_rest', '/management/020_manegement_over_rest', {})
        },
        {
        ...
        {
            path: '/clusters/064_coherence_snapshots',
            meta: {
                h1: 'Coherence Snapshots',
            ...
            component: loadPage('clusters-064_coherence_snapshots', '/clusters/064_coherence_snapshots', {})
        },
        {
    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/management/020_manegement_over_rest', title: 'Management Over ReST' },
                { href: '/management/030_heapdump', title: 'Generating Heap Dumps' },
                { href: '/management/040_visualvm', title: 'Using JVisualVM' },
        ...
        },
        {
            ...
            items: [
                ...
                { href: '/clusters/064_coherence_snapshots', title: 'Coherence Snapshots' },
