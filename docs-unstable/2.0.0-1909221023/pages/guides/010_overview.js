...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#guides/quickstart.adoc" @click.native="this.scrollFix('#guides/quickstart.adoc')"><div class="card__link-hover"/>
</router-link>
...
<p></p>
<p>Follow step-by-step quick start guide to using the Coherence Operator.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/guides/080_management"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/guides/090_metrics"><div class="card__link-hover"/>
</router-link>
<v-card-title primary class="headline layout justify-center">
