...
then the name in the <code>example/scripts/example-rbac.yaml</code> should be modified.</p>
...
>kubectl -n &lt;namespace&gt; create -f example-deployment.yaml</markup>
