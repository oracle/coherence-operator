...
<p>See the in-depth guide on <router-link to="#guides/030_applications.adoc" @click.native="this.scrollFix('#guides/030_applications.adoc')">building Coherence applications</router-link> for more details on creating and
deploying <code>CoherenceClusters</code> with custom application code.</p>
...
<router-link to="#guides/030_applications.adoc" @click.native="this.scrollFix('#guides/030_applications.adoc')">Deploying Coherence Applications</router-link> guide.</p>
...
spec:
  application:
    libDir: app-lib  <span class="conum" data-value="1" /></markup>
...
<ul class="colist">
<li data-value="1">The default value for the <code>libDir</code> field is <code>app-lib/</code>.</li>
<li data-value="2">The <code>data</code> role does not specify a value for <code>libDir</code> so it will use the default. The application image should
contain a directory named <code>/app-lib</code> that contains the <code>.jar</code> files to add to the JVM classpath in all of the <code>Pods</code>
for the <code>data</code> role.</li>
...
<ul class="colist">
<li data-value="1">The default value for the <code>configDir</code> field is <code>app-conf/</code>.</li>
...
in the <code>application.appDir</code> field.</p>
...
<ul class="colist">
<li data-value="1">The default value for the <code>appDir</code> field is <code>/app</code>.</li>
...
<li data-value="2">One of those classes will be <code>com.acme.Main</code> which will be executed as the main class for all roles that do not
specifically specify a <code>main</code>.</li>
<li data-value="3">The <code>data</code> role does not specify an <code>args</code> field so the Coherence JVM in the <code>Pods</code> for the <code>data</code> role will all use
the default arguments of <code>"argOne"</code> and <code>"argTwo"</code></li>
<li data-value="4">The <code>proxy</code> role specifies different arguments. The arguments <code>"argThree"</code> and <code>"argFour"</code> will be passed to the
<code>com.acme.Main</code> class <code>main()</code> method in <code>Pods</code> for the <code>proxy</code> role.</li>
<li data-value="5">The <code>web</code> role specifies an empty array for the <code>args</code> field so no arguments will be passed to its main class.</li>
</ul>
</div>
</div>
</doc-view>
