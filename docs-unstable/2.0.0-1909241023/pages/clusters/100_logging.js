...
<div class="section">
<p>The Coherence log level is set with the <code>logging.level</code> field. This field is an integer value between zero and nine
...
spec:
  logging:
    level: 5 <span class="conum" data-value="1" /></markup>
...
spec:
  roles:
    - role: data
      logging:
        level: 9 <span class="conum" data-value="1" />
    - role: proxy
      logging:
        level: 5 <span class="conum" data-value="2" /></markup>
...
<router-link to="/clusters/065_application_image">application code</router-link> or by <router-link to="/clusters/150_volumes">mounting a volume</router-link> containing
