...
public class HttpTestHelper
    ...
    public HttpTestHelper(int nPort)
        {
        m_nPort = nPort;
        }
     ...
     * @return context path
     */
    public Client getClientWithBasicAuth(String sUser, String sCredentials)
        {
        return createClientBuilder()
                .build()
    ...
    public static final String TRUSTSTORE_RAVAGERS = "certs/truststore-ravagers.jks";

    public static final String CERT_GROOT = "certs/groot.jks";

    public static final String TRUSTSTORE_ALL = "certs/truststore-all.jks";

    public static final String CERT_YONDU = "certs/yondu.jks";

    public static final String CERT_ICARUS = "certs/icarus.jks";
