...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CoherenceImagesSpec) DeepCopyInto(out *CoherenceImagesSpec) {
	*out = *in
	if in.Coherence != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CoherenceImagesSpec.
func (in *CoherenceImagesSpec) DeepCopy() *CoherenceImagesSpec {
	if in == nil {
		return nil
	}
	out := new(CoherenceImagesSpec)
	in.DeepCopyInto(out)
	return out
}
