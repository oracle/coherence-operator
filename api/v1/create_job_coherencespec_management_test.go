...
func TestCreateJobWithCoherenceManagementEnabledTrue(t *testing.T) {
	...
	// Create expected Job
	jobExpected := createMinimalExpectedJob(deployment)
	addEnvVarsToJob(jobExpected, coh.ContainerNameCoherence, corev1.EnvVar{Name: "COH_MGMT_ENABLED", Value: "true"})
	addEnvVarsToJob(jobExpected, coh.ContainerNameCoherence, corev1.EnvVar{Name: "COH_MGMT_PORT", Value: strconv.FormatInt(int64(coh.DefaultManagementPort), 10)})
...
func TestCreateJobWithCoherenceManagementEnabledWithPort(t *testing.T) {
	...
	jobExpected := createMinimalExpectedJob(deployment)
	addEnvVarsToJob(jobExpected, coh.ContainerNameCoherence, corev1.EnvVar{Name: "COH_MGMT_ENABLED", Value: "true"})
	addEnvVarsToJob(jobExpected, coh.ContainerNameCoherence, corev1.EnvVar{Name: "COH_MGMT_PORT", Value: "1234"})
