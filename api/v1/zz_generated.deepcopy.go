...
func (in *ApplicationSpec) DeepCopyInto(out *ApplicationSpec) {
	*out = *in
	...
	if in.UseImageEntryPoint != nil {
		in, out := &in.UseImageEntryPoint, &out.UseImageEntryPoint
		*out = new(bool)
		**out = **in
	}
	if in.UseJdkJavaOptions != nil {
		in, out := &in.UseJdkJavaOptions, &out.UseJdkJavaOptions
		*out = new(bool)
		**out = **in
	}
	if in.AlternateJdkJavaOptions != nil {
		in, out := &in.AlternateJdkJavaOptions, &out.AlternateJdkJavaOptions
		*out = new(string)
		**out = **in
	}
}
...
func (in *CoherenceJobProbe) DeepCopyInto(out *CoherenceJobProbe) {
	*out = *in
	...
	if in.ReadyCount != nil {
		in, out := &in.ReadyCount, &out.ReadyCount
		*out = new(int32)
		**out = **in
	}
}
...
func (in *CoherenceJobProbeStatus) DeepCopy() *CoherenceJobProbeStatus {
	if in == nil {
		return nil
	}
	out := new(CoherenceJobProbeStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CoherenceJobResourceSpec) DeepCopyInto(out *CoherenceJobResourceSpec) {
	*out = *in
	...
	if in.ReadyAction != nil {
		in, out := &in.ReadyAction, &out.ReadyAction
		*out = new(CoherenceJobProbe)
		(*in).DeepCopyInto(*out)
	}
	if in.ForceExit != nil {
		in, out := &in.ForceExit, &out.ForceExit
		*out = new(bool)
		**out = **in
	}
	if in.EnvFrom != nil {
...
func (in *CoherenceJobResourceSpec) DeepCopy() *CoherenceJobResourceSpec {
	if in == nil {
		return nil
	}
	out := new(CoherenceJobResourceSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CoherenceJobStatus) DeepCopyInto(out *CoherenceJobStatus) {
	*out = *in
	in.CoherenceResourceStatus.DeepCopyInto(&out.CoherenceResourceStatus)
	if in.ProbeStatus != nil {
		in, out := &in.ProbeStatus, &out.ProbeStatus
		*out = make([]CoherenceJobProbeStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CoherenceResourceStatus) DeepCopyInto(out *CoherenceResourceStatus) {
	*out = *in
	...
	if in.JobProbes != nil {
		in, out := &in.JobProbes, &out.JobProbes
		*out = make([]CoherenceJobProbeStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *CoherenceStatefulSetResourceSpec) DeepCopyInto(out *CoherenceStatefulSetResourceSpec) {
	*out = *in
	...
	if in.AllowUnsafeDelete != nil {
		in, out := &in.AllowUnsafeDelete, &out.AllowUnsafeDelete
		*out = new(bool)
		**out = **in
	}
	if in.Actions != nil {
	...
	if in.RollingUpdateStrategy != nil {
		...
		*out = new(RollingUpdateStrategyType)
		**out = **in
	}
	if in.RollingUpdateLabel != nil {
		in, out := &in.RollingUpdateLabel, &out.RollingUpdateLabel
		*out = new(string)
		**out = **in
	}
	if in.HeadlessServiceIpFamilies != nil {
		in, out := &in.HeadlessServiceIpFamilies, &out.HeadlessServiceIpFamilies
...
func (in *CoherenceStatefulSetResourceSpec) DeepCopy() *CoherenceStatefulSetResourceSpec {
	if in == nil {
		return nil
	}
	out := new(CoherenceStatefulSetResourceSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CoherenceUtilsSpec) DeepCopyInto(out *CoherenceUtilsSpec) {
	*out = *in
	if in.ImagePullPolicy != nil {
		in, out := &in.ImagePullPolicy, &out.ImagePullPolicy
		*out = new(corev1.PullPolicy)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CoherenceUtilsSpec.
func (in *CoherenceUtilsSpec) DeepCopy() *CoherenceUtilsSpec {
	if in == nil {
		return nil
	}
	out := new(CoherenceUtilsSpec)
...
func (in *NamedPortSpec) DeepCopyInto(out *NamedPortSpec) {
	*out = *in
	...
	if in.ExposeOnSTS != nil {
		in, out := &in.ExposeOnSTS, &out.ExposeOnSTS
		*out = new(bool)
		**out = **in
	}
}
