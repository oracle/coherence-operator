...
///////////////////////////////////////////////////////////////////////////////
= Build a Coherence Server Image
...
[TIP]
====
image:GitHub-Mark-32px.png[] The complete source code for this example is in the https://github.com/oracle/coherence-operator/tree/master/examples/015_simple_image[Coherence Operator GitHub] repository.
====
...
In this example we're going to add management over REST to the application by adding a dependency on `coherence-management`.
