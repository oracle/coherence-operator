...
When using the default Coherence images, for example `ghcr.io/oracle/coherence-ce:21.12.4` the Extend proxy is already
...
When using the default Coherence images, for example `ghcr.io/oracle/coherence-ce:21.12.4` the Concurrent Extend proxy is already
...
When using the default Coherence images, for example `ghcr.io/oracle/coherence-ce:21.12.4` the gRPC proxy is already
