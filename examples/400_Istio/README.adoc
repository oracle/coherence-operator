...
Coherence clusters managed with the Coherence Operator 3.5.10 and later work with Istio 1.9.1 and later out of the box.
...
After installing the operator, use the following command to confirm the operator is running:
