...
public class ClusterMemberProbeIT
    {
    @Test
    public void shouldBeLiveIfCoherenceStartedFirst() throws Exception
        {
    ...
    @Test
    public void shouldNotBeLiveIfCoherenceStartedSecond() throws Exception
        {
    ...
    @Test
    public void shouldBeReadyWhenSingleMember() throws Exception
        {
        try (CoherenceCluster cluster = startCluster(1))
            {
    ...
    @Test
    public void shouldBeReadyWhenMultipleMembers() throws Exception
        {
    ...
    @Test
    public void shouldBeReadyWhenMultipleMembersWithZeroBackups() throws Exception
        {
        try (CoherenceCluster cluster = startCluster(2))
            {
            try (JavaApplication appPodCheck = runPodChecker(PodChecker.Type.readiness))
