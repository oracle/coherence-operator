...
public class RetryingWkaAddressProviderTest {
    ...
    public void testShouldTimeoutOnNonExistentDnsReference() {
        ...
        Iterable<AddressHolder> holders = () -> Collections.singletonList(new AddressHolder("NonExiStentHoStName12345678", 0)).iterator();
    ...
    public void testShouldRevolveImmediately()
        ...
        assertThat("confirm wka resolved", provider.getNextAddress(), is(notNullValue()));
