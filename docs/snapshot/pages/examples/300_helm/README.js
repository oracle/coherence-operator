...
>docker pull ghcr.io/oracle/coherence-operator:3.2.10
docker run -it --rm ghcr.io/oracle/coherence-operator:3.2.10 status -h</markup>
...
operator:
  ...
  port: 8000
  image: ghcr.io/oracle/coherence-operator-utils:3.2.10
  condition: Ready
  timeout: 5m
  interval: 10s</markup>
