...
<p ><p><img src="./images/GitHub-Mark-32px.png" alt="GitHub Mark 32px" />
 The complete source code for this example is in the <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/tree/master/examples/300_helm">Coherence Operator GitHub</a> repository.</p>
</p>
</div>
...
>docker pull ghcr.io/oracle/coherence-operator-utils:3.2.7
docker run -it --rm ghcr.io/oracle/coherence-operator-utils:3.2.7 status -h</markup>
...
operator:
  ...
  port: 8000
  image: ghcr.io/oracle/coherence-operator:3.2.7-utils
  condition: Ready
  timeout: 5m
  interval: 10s</markup>
