...
<dd slot="desc"><p>The Coherence Operator is available as an image from the GitHub container registry <code>ghcr.io/oracle/coherence-operator:3.2.12</code> that can
...
<ul class="ulist">
<li>
<p><code>ghcr.io/oracle/coherence-operator:3.2.12</code> - The Operator image.</p>
...
>kubectl apply -f https://github.com/oracle/coherence-operator/releases/download/v3.2.12/coherence-operator.yaml</markup>
...
<div class="section">
<p>The Helm chart uses a default Operator image from <code>ghcr.io/oracle/coherence-operator:3.2.12</code>.
...
with the same image name <code>coherence-operator</code> and tag <code>3.2.12</code> as the default image,
then just the <code>image.registry</code> needs to be specified.</p>

<p>In the example below, the image used to run the Operator will be <code>foo.com/coherence-operator:3.2.12</code>.</p>
...
<p>Download the
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.2.12/coherence-operator-manifests.tar.gz">3.2.12 Manifests</a>
...
>cd ./manager &amp;&amp; kustomize edit set image controller=myregistry/coherence-operator:3.2.12</markup>
...
>cd ./manager &amp;&amp; kustomize edit add configmap env-vars --from-literal OPERATOR_IMAGE=myregistry/coherence-operator:3.2.12</markup>
...
<ul class="ulist">
<li>
<p><code>ghcr.io/oracle/coherence-operator-package:3.2.12</code> - the Coherence Operator package</p>

</li>
<li>
<p><code>ghcr.io/oracle/coherence-operator-repo:3.2.12</code> - the Coherence Operator repository</p>
...
>tanzu package repository add coherence-repo \
    --url ghcr.io/oracle/coherence-operator-repo:3.2.12 \
    --namespace coherence \
...
coherence-operator.oracle.github.com  Oracle Coherence Operator  A Kubernetes operator for managing Oracle Coherence clusters  3.2.12</markup>
...
coherence  coherence-operator.oracle.github.com  3.2.12            Reconcile succeeded</markup>
