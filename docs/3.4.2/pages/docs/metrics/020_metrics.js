...
<div class="section">
<p>From version 3.4.2 of the Coherence Operator, the packaged Grafana dashboards no longer use the <strong>vendor:</strong> prefix for querying Prometheus metrics.
