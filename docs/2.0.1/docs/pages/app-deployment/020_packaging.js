...
<p class="admonition-inline">It is recommended to use the <code>scratch</code> image in the <code>FROM</code> clause to minimize the size of the resultant image.</p>
</div>
