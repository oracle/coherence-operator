...
<dd slot="desc"><p>The Coherence Operator is available as a Docker image <code>oracle/coherence-operator:3.2.6</code> that can
...
>kubectl apply -f https://github.com/oracle/coherence-operator/releases/download/v3.2.6/coherence-operator.yaml</markup>
...
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.2.6/coherence-operator-manifests.tar.gz">3.2.6 Manifests</a></p>
...
<p>Download the
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.2.6/coherence-operator-manifests.tar.gz">3.2.6 Manifests</a>
...
>cd ./manager &amp;&amp; kustomize edit set image controller=myregistry/coherence-operator:3.2.6</markup>
...
>cd ./manager &amp;&amp; kustomize edit add configmap env-vars --from-literal UTILS_IMAGE=myregistry/coherence-operator:3.2.6-utils</markup>
