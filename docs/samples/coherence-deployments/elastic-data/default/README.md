...
1. Change to the `samples/coherence-deployments/elastic-data/default` directory and ensure you have your maven build environment set for JDK8 and build the project.
