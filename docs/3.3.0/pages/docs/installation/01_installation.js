...
<dd slot="desc"><p>The Coherence Operator is available as an image from the GitHub container registry <code>ghcr.io/oracle/coherence-operator:3.3.0</code> that can
...
<ul class="ulist">
<li>
<p><code>ghcr.io/oracle/coherence-operator:3.3.0</code> - The Operator image.</p>
...
<div class="section">
<p>The Helm chart uses a default Operator image from <code>ghcr.io/oracle/coherence-operator:3.3.0</code>.
...
with the same image name <code>coherence-operator</code> and tag <code>3.3.0</code> as the default image,
then just the <code>image.registry</code> needs to be specified.</p>

<p>In the example below, the image used to run the Operator will be <code>foo.com/coherence-operator:3.3.0</code>.</p>
...
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.3.0/coherence-operator-manifests.tar.gz">3.3.0 Manifests</a></p>
...
<p>Download the
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.3.0/coherence-operator-manifests.tar.gz">3.3.0 Manifests</a>
...
<ul class="ulist">
<li>
<p><code>ghcr.io/oracle/coherence-operator-package:3.3.0</code> - the Coherence Operator package</p>

</li>
<li>
<p><code>ghcr.io/oracle/coherence-operator-repo:3.3.0</code> - the Coherence Operator repository</p>
