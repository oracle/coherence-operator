...
function createRoutes(){
    return [
        ...
        {
            path: '/docs/examples/010_overview',
            meta: {
                h1: 'Overview',
                title: 'Overview',
                h1Prefix: null,
            ...
            component: loadPage('docs-examples-010_overview', '/docs/examples/010_overview', {})
        },
        {
            path: '/docs/examples/020_deployment',
            meta: {
            ...
            component: loadPage('docs-examples-020_deployment', '/docs/examples/020_deployment', {})
        },
        {
            path: '/docs/examples/030_federation',
            meta: {
                h1: 'Coherence Federation Example',
                title: 'Coherence Federation Example',
                h1Prefix: null,
                description: null,
                keywords: null,
                customLayout: null,
            ...
            component: loadPage('docs-examples-030_federation', '/docs/examples/030_federation', {})
        },
        {
            path: '/docs/examples/100_tls',
            meta: {
            ...
            component: loadPage('docs-examples-100_tls', '/docs/examples/100_tls', {})
        },
        {
            path: '/docs/examples/500_autoscaler',
            meta: {
            ...
            component: loadPage('docs-examples-500_autoscaler', '/docs/examples/500_autoscaler', {})
        },
        {
            path: '/docs/examples/800_istio',
            meta: {
                h1: 'Istio Support',
                title: 'Istio Support',
                h1Prefix: null,
            ...
            component: loadPage('docs-examples-800_istio', '/docs/examples/800_istio', {})
        },
        {
            path: '/docs/examples/810_helm',
            meta: {
            ...
            component: loadPage('docs-examples-810_helm', '/docs/examples/810_helm', {})
        },
        {
            path: '/docs/examples/900_demo',
            meta: {
            ...
            component: loadPage('docs-examples-900_demo', '/docs/examples/900_demo', {})
        },
        {
...
function createNav(){
    return [
        ...
        },
        {
            ...
            group: '/examples',
            items: [
                { href: '/docs/examples/010_overview', title: 'Overview' },
                { href: '/docs/examples/020_deployment', title: 'Coherence Deployment Example' },
                { href: '/docs/examples/030_federation', title: 'Coherence Federation Example' },
                { href: '/docs/examples/100_tls', title: 'Secure Coherence Using TLS' },
                { href: '/docs/examples/500_autoscaler', title: 'Autoscaling Coherence Cluster' },
                { href: '/docs/examples/800_istio', title: 'Istio Support' },
                { href: '/docs/examples/810_helm', title: 'Manage Coherence using Helm' },
                { href: '/docs/examples/900_demo', title: 'The Coherence Demo App' }
            ]
        },
        {
