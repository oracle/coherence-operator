...
* Since Operator 3.5.11 it is possible to configure the IP family for the WKA Service. The `spec.coherence.wka.ipFamily`
...
Since Operator 3.5.11 it is also possible to configure the IP families used by the headless service created for the StatefulSet
if this is required.
