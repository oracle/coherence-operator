...
this suffix is `ci` so the default version of the build artifacts is `3.0.0-ci`. Change this suffix, for
...
==== Unit Tests
The Coherence Operator contains tests that can be executed using `make test`.
