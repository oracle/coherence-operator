...
kubectl -n monitoring create \
    -f https://oracle.github.io/coherence-operator/dashboards/${VERSION}/coherence-grafana-dashboards.yaml</markup>
...
In this example the dashboards will be installed into the <code>monitoring</code> namespace.</p>

<p>The example above installs the dashboards configured to use Coherence MP metrics, to use dashboards for
metrics produced with Coherence legacy metric names change the yaml file name in the
URL to <code>coherence-grafana-legacy-dashboards.yaml</code>, for example:</p>
...
>VERSION=3.0.2
kubectl -n monitoring create \
    -f https://oracle.github.io/coherence-operator/dashboards/${VERSION}/coherence-grafana-legacy-dashboards.yaml</markup>
