...
<dd slot="desc"><p>The Coherence Operator uses the OSS Coherence CE image as the image to run when no image has been specified
for a <code>Coherence</code> resource.
Commercial Coherence images are not available from public image registries and must be pulled from the
Oracle Container Registry.</p>
</dd>
</dl>
</v-card-text>
</v-card>
