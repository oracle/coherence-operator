...
<dd slot="desc"><p>The Coherence Operator is available as a Docker image <code>oracle/coherence-operator:3.2.3</code> that can
...
>kubectl apply -f https://github.com/oracle/coherence-operator/releases/download/v3.2.3/coherence-operator.yaml</markup>
...
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.2.3/coherence-operator-manifests.tar.gz">3.2.3 Manifests</a></p>
...
<p>Download the
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.2.3/coherence-operator-manifests.tar.gz">3.2.3 Manifests</a>
...
>cd ./manager &amp;&amp; kustomize edit set image controller=container-registry.oracle.com/middleware/coherence-operator:3.2.3</markup>
...
>cd ./manager &amp;&amp; kustomize edit add configmap env-vars --from-literal UTILS_IMAGE=container-registry.oracle.com/middleware/coherence-operator:3.2.3-utils</markup>
