...
<ul class="ulist">
<li>
<p>Since Operator 3.5.1 it is possible to configure the IP family for the WKA Service. The <code>spec.coherence.wka.ipFamily</code>
...
<p>Since Operator 3.5.1 it is also possible to configure the IP families used by the headless service created for the StatefulSet
