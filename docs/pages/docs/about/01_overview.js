...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/applications/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/examples/000_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Guides & Examples</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>There are a number of examples of using the Coherence Operator and different Coherence features in Kubernetes.</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/examples/no-operator/000_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">fa-ban</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Non-Operator Guides & Examples</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Examples for those in the unlucky situation of not being able to install Operators, CRDs, RBAC cluster roles etc, and therfore need to manage Coherence clusters manually.</p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/scaling/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/coherence/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/jvm/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/ports/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/networking/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Networking</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Configure networking settings.</p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/metrics/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/management/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/logging/010_overview"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/docs/about/04_coherence_spec"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">widgets</v-icon>
