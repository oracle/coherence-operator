...
<p ><p><img src="./images/GitHub-Mark-32px.png" alt="GitHub Mark 32px" />
 The complete source code for this example is in the <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/tree/main/examples/200_autoscaler">Coherence Operator GitHub</a> repository.</p>
</p>
</div>
</div>
...
<p>Prometheus will get metrics from the Coherence Pod&#8217;s metrics endpoints.
...
<p ><p>When using the HPA it is important to understand how the replica field in the Coherence resource
is applied to avoid inadvertently resizing an autoscaled cluster when applying updates to the YAML.</p>

<p>See the explanation in <router-link :to="{path: '/docs/scaling/010_overview', hash: '#problem'}">Scale Coherence Deployments - The Problem</router-link></p>
</p>
</div>
</div>
...
<a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/using-coherence-metrics.html#GUID-CFC31D23-06B8-49AF-8996-ADBA806E0DD9">how to add custom metrics</a>
and
<a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/registering-custom-mbeans.html#GUID-1EE749C5-BC0D-4353-B5FE-1C5DCDEAE48C">how to register custom MBeans</a>.</p>
...
<li>
<p>A suitable container platform such as Podman or Docker.</p>

</li>
<li>
<p>Access to a Kubernetes cluster running a currently supported Kubernetes version.</p>

</li>
<li>
<p><a id="" title="" target="_blank" href="https://kubernetes.io/docs/tasks/tools/install-kubectl/">kubectl</a>.</p>

</li>
<li>
<p><a id="" title="" target="_blank" href="https://helm.sh/docs/intro/install/">Helm</a>.</p>
