...
Coherence clusters managed with the Coherence Operator 3.5.15 and later work with Istio 1.9.1 and later out of the box.
...
Operator <router-link to="/docs/installation/001_installation">Installation Guide</router-link>.</p>

<p>After installing the operator, use the following command to confirm the operator is running:</p>
