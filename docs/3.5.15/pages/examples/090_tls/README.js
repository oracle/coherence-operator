...
<div class="section">
<p>To run the examples below, you will need to have installed the Coherence Operator, do this using whatever method you prefer from the <a id="" title="" target="_blank" href="https://docs.coherence.community/coherence-operator/docs/latest/docs/installation/001_installation">Installation Guide</a></p>
...
<p>The Coherence documentation has a lot of details on configuring socket providers in the section on <a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/secure/using-ssl-secure-communication.html#GUID-94D85286-169B-4FAA-ABE1-FF2EFC82C776">Using SSL Secure Communication</a></p>
...
<div class="section">
<p>Now we have a "tls" socket provider we can use it to secure Coherence. The Coherence documentation has a section on <a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/secure/using-ssl-secure-communication.html">Using SSL/TLS to Secure Communication</a>.
...
<div class="section">
<p>A common connection type to secure are client connections into the cluster from Coherence Extend clients. The Coherence documentation contains details on <a id="" title="" target="_blank" href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/secure/using-ssl-secure-communication.html#GUID-C012F002-2868-401D-8A43-E9CA076DB841">Using SSL to Secure Extend and gRPC Client Communication</a> for more in-depth details.</p>
