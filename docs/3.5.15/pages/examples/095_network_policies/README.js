...
<div class="admonition note">
<p class="admonition-textlabel">Note</p>
<p ><p>If the operator cannot connect to the API server it will fail to start.
...
If the network policies are blocking the operator from connecting to the API server this request will time out.</p>
...
spec:
  template:
    ...
    spec:
      containers:
      - name: net-test
        image: container-registry.oracle.com/middleware/coherence-operator:3.5.15
        env:
          - name: HOST
