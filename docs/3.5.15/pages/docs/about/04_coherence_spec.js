...
<td class="">&#160;</td>
<td class=""><code><a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#objectmeta-v1-meta">metav1.ObjectMeta</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code><a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#jobspec-v1-batch">batchv1.JobSpec</a></code></td>
<td class="">true</td>
</tr>
<tr>
...
<td class=""><code>metadata</code></td>
<td class="">&#160;</td>
<td class=""><code><a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta">metav1.ListMeta</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class="">&#160;</td>
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#time-v1-meta">metav1.Time</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#podfailurepolicy-v1-batch">batchv1.PodFailurePolicy</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#envfromsource-v1-core">corev1.EnvFromSource</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#resourcerequirements-v1-core">corev1.ResourceRequirements</a></code></td>
<td class="">false</td>
</tr>
</tbody>
</table>
...
<td class="">The desired number of cluster members of this deployment.<br>
<br>
If the cluster will be scaled using the Horizontal Pod Autoscaler or the kubectl scale command then this field should be left unset and the initial cluster size should be specified using the <code>initialReplicas</code> field.<br>
<br>
This is a pointer to distinguish between explicit zero and not specified. If not specified a default value of 3 will be used. This field cannot be negative.</td>
<td class=""><code>&#42;int32</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>initialReplicas</code></td>
<td class="">The initial number of cluster members of this deployment when first created.<br>
<br>
If the <code>replicas</code> field is set this field is ignored.<br>
<br>
This field is to set an initial size for a cluster that is then resized only using the Horizontal Pod Autoscaler or the kubectl scale command.<br>
<br>
This is a pointer to distinguish between explicit zero and not specified. If not specified a default value of 3 will be used. This field cannot be negative.</td>
<td class=""><code>&#42;int32</code></td>
<td class="">false</td>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#envvar-v1-core">corev1.EnvVar</a></code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>labels</code></td>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#container-v1-core">corev1.Container</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#volume-v1-core">corev1.Volume</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#volumemount-v1-core">corev1.VolumeMount</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#podreadinessgate-v1-core">corev1.PodReadinessGate</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#affinity-v1-core">corev1.Affinity</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#toleration-v1-core">corev1.Toleration</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#podsecuritycontext-v1-core">corev1.PodSecurityContext</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#securitycontext-v1-core">corev1.SecurityContext</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#topologyspreadconstraint-v1-core">corev1.TopologySpreadConstraint</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#lifecycle-v1-core">corev1.Lifecycle</a></code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>minReadySeconds</code></td>
<td class="">Minimum number of seconds for which a newly created pod should be ready without any of its container crashing for it to be considered available. Defaults to 0 (pod will be considered available as soon as it is ready)</td>
<td class=""><code>&#42;int32</code></td>
<td class="">false</td>
</tr>
</tbody>
...
<tr>
<td class=""><code>image</code></td>
<td class="">Image is used to set the utils image used in Coherence Pods.<br>
<br>
Deprecated: This field is deprecated and no longer used, any value set will be ignored.</td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
</tbody>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#keytopath-v1-core">corev1.KeyToPath</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#volume-v1-core">https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#volume-v1-core</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#hostalias-v1-core">corev1.HostAlias</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#persistentvolumeclaimspec-v1-core">corev1.PersistentVolumeClaimSpec</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>[]<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#poddnsconfigoption-v1-core">corev1.PodDNSConfigOption</a></code></td>
<td class="">false</td>
</tr>
</tbody>
</table>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#execaction-v1-core">corev1.ExecAction</a></code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>httpGet</code></td>
<td class="">HTTPGet specifies the http request to perform.</td>
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#httpgetaction-v1-core">corev1.HTTPGetAction</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#tcpsocketaction-v1-core">corev1.TCPSocketAction</a></code></td>
<td class="">false</td>
</tr>
</tbody>
</table>
...
<td class="">Keystore is the Java key store value used as the SSL keystore when configuring component<br>
  over REST to use SSL. When Secrets is set this is a file name in that k8s secret; +<br>
  without Secrets it is an explicit path in the container, which lets users provide +<br>
  externally mounted stores without rewriting them as secret keys.<br></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>keyStorePasswordFile</code></td>
<td class="">KeyStorePasswordFile is the file containing the keystore password when configuring<br>
  component over REST to use SSL. When Secrets is set this is a file name in that k8s +<br>
  secret; without Secrets it is an explicit path in the container read by the +<br>
  operator&#8217;s FileBasedPasswordProvider.<br></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>keyPasswordFile</code></td>
<td class="">KeyPasswordFile is the file containing the key password when configuring component over<br>
  REST to use SSL. When Secrets is set this is a file name in that k8s secret; without +<br>
  Secrets it is an explicit path in the container read by the operator&#8217;s +<br>
  FileBasedPasswordProvider.<br></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class="">TrustStore is the Java trust store value used as the SSL trust store when configuring<br>
  component over REST to use SSL. When Secrets is set this is a file name in that k8s +<br>
  secret; without Secrets it is an explicit path in the container, which keeps trust-only +<br>
  configurations independent from the keystore settings.<br></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>trustStorePasswordFile</code></td>
<td class="">TrustStorePasswordFile is the file containing the trust store password when configuring<br>
  component over REST to use SSL. When Secrets is set this is a file name in that k8s +<br>
  secret; without Secrets it is an explicit path in the container read by the +<br>
  operator&#8217;s FileBasedPasswordProvider.<br></td>
<td class=""><code>&#42;string</code></td>
...
<td class="">The label to use to retrieve the job name from. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec</a></td>
<td class=""><code>string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>targetLabels</code></td>
<td class="">TargetLabels transfers labels on the Kubernetes Service onto the target. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec</a></td>
<td class=""><code>[]string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>podTargetLabels</code></td>
<td class="">PodTargetLabels transfers labels on the Kubernetes Pod onto the target. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec</a></td>
<td class=""><code>[]string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>sampleLimit</code></td>
<td class="">SampleLimit defines per-scrape limit on number of scraped samples that will be accepted. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.ServiceMonitorSpec</a></td>
<td class=""><code>&#42;uint64</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>path</code></td>
<td class="">HTTP path to scrape for metrics. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>scheme</code></td>
<td class="">HTTP scheme to use for scraping. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>&#42;monitoringv1.Scheme</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>params</code></td>
<td class="">Optional HTTP URL parameters See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>map[string][]string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>interval</code></td>
<td class="">Interval at which metrics should be scraped See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>monitoringv1.Duration</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>scrapeTimeout</code></td>
<td class="">Timeout after which the scrape is ended See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>monitoringv1.Duration</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>tlsConfig</code></td>
<td class="">TLS configuration to use when scraping the endpoint See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>&#42;monitoringv1.TLSConfig</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>bearerTokenFile</code></td>
<td class="">File to read bearer token for scraping targets.<br>
<br>
Deprecated: use <code>authorization</code> instead.</td>
<td class=""><code>string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>bearerTokenSecret</code></td>
<td class="">Secret to mount to read bearer token for scraping targets. The secret needs to be in the same namespace as the service monitor and accessible by the Prometheus Operator.<br>
<br>
Deprecated: use <code>authorization</code> instead.</td>
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#secretkeyselector-v1-core">corev1.SecretKeySelector</a></code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>authorization</code></td>
<td class=""><code>authorization</code> configures the Authorization header credentials to use when scraping the target. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a><br>
<br>
...
<td class="">HonorLabels chooses the metric labels on collisions with target labels. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>bool</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>honorTimestamps</code></td>
<td class="">HonorTimestamps controls whether Prometheus respects the timestamps present in scraped data. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>&#42;bool</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>basicAuth</code></td>
<td class="">BasicAuth allow an endpoint to authenticate over basic authentication More info: <a id="" title="" target="_blank" href="https://prometheus.io/docs/operating/configuration/#endpoints">https://prometheus.io/docs/operating/configuration/#endpoints</a> See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>&#42;monitoringv1.BasicAuth</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>metricRelabelings</code></td>
<td class="">MetricRelabelings to apply to samples before ingestion. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>[]monitoringv1.RelabelConfig</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>relabelings</code></td>
<td class="">Relabelings to apply to samples before scraping. More info: <a id="" title="" target="_blank" href="https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config">https://prometheus.io/docs/prometheus/latest/configuration/configuration/#relabel_config</a> See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>[]monitoringv1.RelabelConfig</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>proxyURL</code></td>
<td class="">ProxyURL eg <a id="" title="" target="_blank" href="http://proxyserver:2195">http://proxyserver:2195</a> Directs scrapes to proxy through this endpoint. See <a id="" title="" target="_blank" href="https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint">https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.Endpoint</a></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
</tbody>
...
<td class="">clusterIP is the IP address of the service and is usually assigned randomly by the master. If an address is specified manually and is not in use by others, it will be allocated to the service; otherwise, creation of the service will fail. This field can not be changed through updates. Valid values are "None", empty string (""), or a valid IP address. "None" can be specified for headless services when proxying is not required. Only applies to types ClusterIP, NodePort, and LoadBalancer. Ignored if type is ExternalName. More info: <a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/networking/virtual-ips/">https://kubernetes.io/docs/reference/networking/virtual-ips/</a></td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
...
<br>
Unless the "IPv6DualStack" feature gate is enabled, this field is limited to one value, which must be the same as the clusterIP field.  If the feature gate is enabled, this field may hold a maximum of two entries (dual-stack IPs, in either order).  These IPs must correspond to the values of the ipFamilies field. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field. More info: <a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/networking/virtual-ips/">https://kubernetes.io/docs/reference/networking/virtual-ips/</a></td>
<td class=""><code>[]string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>loadBalancerIP</code></td>
<td class="">LoadBalancerIP is the IP address of the load balancer<br>
<br>
Deprecated: This field is deprecated in the Kubernetes API.</td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class="">Supports "ClientIP" and "None". Used to maintain session affinity. Enable client IP based session affinity. Must be ClientIP or None. Defaults to None. More info: <a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/networking/virtual-ips/">https://kubernetes.io/docs/reference/networking/virtual-ips/</a></td>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://pkg.go.dev/k8s.io/api/core/v1#ServiceExternalTrafficPolicy">https://pkg.go.dev/k8s.io/api/core/v1#ServiceExternalTrafficPolicy</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#sessionaffinityconfig-v1-core">corev1.SessionAffinityConfig</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://pkg.go.dev/k8s.io/api/core/v1#IPFamilyPolicy">https://pkg.go.dev/k8s.io/api/core/v1#IPFamilyPolicy</a></code></td>
<td class="">false</td>
</tr>
<tr>
...
<tr>
<td class=""><code>loadBalancerClass</code></td>
<td class="">loadBalancerClass is the class of the load balancer implementation this Service belongs to. If specified, the value of this field must be a label-style identifier, with an optional prefix, e.g. "internal-vip" or "example.com/internal-vip". Unprefixed names are reserved for end-users. This field can only be set when the Service type is 'LoadBalancer'. If not set, the default load balancer implementation is used, today this is typically done through the cloud provider integration, but should apply for any default implementation. If set, it is assumed that a load balancer implementation is watching for Services with a matching class. Any default load balancer implementation (e.g. cloud providers) should ignore Services that set this field. This field can only be set when creating or updating a Service to type 'LoadBalancer'. Once set, it can not be changed. This field will be wiped when a service is updated to a non 'LoadBalancer' type.</td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>internalTrafficPolicy</code></td>
<td class="">InternalTrafficPolicy describes how nodes distribute service traffic they receive on the ClusterIP. If set to "Local", the proxy will assume that pods only want to talk to endpoints of the service on the same node as the pod, dropping the traffic if there are no local endpoints. The default value, "Cluster", uses the standard behavior of routing to all endpoints evenly (possibly modified by topology and other features).</td>
<td class=""><code>&#42;<a id="" title="" target="_blank" href="https://pkg.go.dev/k8s.io/api/core/v1#ServiceInternalTrafficPolicy">https://pkg.go.dev/k8s.io/api/core/v1#ServiceInternalTrafficPolicy</a></code></td>
<td class="">false</td>
</tr>
<tr>
<td class=""><code>trafficDistribution</code></td>
<td class="">TrafficDistribution offers a way to express preferences for how traffic is distributed to Service endpoints. Implementations can use this field as a hint, but are not required to guarantee strict adherence. If the field is not set, the implementation will apply its default routing strategy. If set to "PreferClose", implementations should prioritize endpoints that are in the same zone.</td>
<td class=""><code>&#42;string</code></td>
<td class="">false</td>
</tr>
</tbody>
