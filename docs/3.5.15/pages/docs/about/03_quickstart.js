...
see <router-link to="#docs/installation/04_obtain_coherence_images.adoc" @click.native="this.scrollFix('#docs/installation/04_obtain_coherence_images.adoc')">Obtain Coherence Images</router-link>.
