...
<p>Also see <router-link to="#docs/installation/05_private_repos.adoc" @click.native="this.scrollFix('#docs/installation/05_private_repos.adoc')">Using Private Image Registries</router-link></p>
