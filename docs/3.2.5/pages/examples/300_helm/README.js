...
>docker pull ghcr.io/oracle/coherence-operator:3.2.5-utils
docker run -it --rm ghcr.io/oracle/coherence-operator:3.2.5-utils status -h</markup>
...
operator:
  ...
  port: 8000
  image: ghcr.io/oracle/coherence-operator:3.2.5-utils
  condition: Ready
  timeout: 5m
  interval: 10s</markup>
