...
<dd slot="desc"><p>The Coherence Operator is available as a Docker image <code>oracle/coherence-operator:3.2.5</code> that can
...
<li>
<p>Access to a Kubernetes v1.16.0+ cluster. The Operator test pipeline is run using Kubernetes versions v1.16 upto v1.23</p>
...
>kubectl apply -f https://github.com/oracle/coherence-operator/releases/download/v3.2.5/coherence-operator.yaml</markup>
...
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.2.5/coherence-operator-manifests.tar.gz">3.2.5 Manifests</a></p>
...
<p>Download the
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.2.5/coherence-operator-manifests.tar.gz">3.2.5 Manifests</a>
...
>cd ./manager &amp;&amp; kustomize edit set image controller=myregistry/coherence-operator:3.2.5</markup>
...
>cd ./manager &amp;&amp; kustomize edit add configmap env-vars --from-literal UTILS_IMAGE=myregistry/coherence-operator:3.2.5-utils</markup>
