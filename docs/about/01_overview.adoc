...
[CARD]
.Troubleshooting
[icon=fa-question-circle,link=troubleshooting/01_trouble-shooting.adoc]
--
...
[CARD]
.Configure Coherence
[icon="fa-cogs",link=coherence/010_overview.adoc]
--
...
[CARD]
.Configure the JVM
[icon=fa-cog,link=jvm/010_overview.adoc]
--
