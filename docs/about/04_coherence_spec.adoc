...
A value of -1 disables tracing completely. +
 +
The Coherence default is -1 if not overridden. For values other than -1, numbers between 0 and 1 are acceptable. Values entered less than zero will be treated as -1, values entered greater than 1 will be treated as 1. m| &#42;resource.Quantity | false
|===
