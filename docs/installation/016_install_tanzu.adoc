...
tanzu package repository add coherence-repo \
    --url ghcr.io/oracle/coherence-operator-repo:3.5.13 \
    --namespace coherence \
    --create-namespace
----
...
coherence-operator.oracle.github.com  Oracle Coherence Operator  A Kubernetes operator for managing Oracle Coherence clusters  3.5.13
----
...
coherence  coherence-operator.oracle.github.com  3.5.13            Reconcile succeeded
----
