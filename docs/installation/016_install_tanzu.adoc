...
tanzu package repository add coherence-repo \
    --url ghcr.io/oracle/coherence-operator-repo:3.5.16 \
    --namespace coherence \
    --create-namespace
----
...
coherence-operator.oracle.github.com  Oracle Coherence Operator  A Kubernetes operator for managing Oracle Coherence clusters  3.5.16
----
...
coherence  coherence-operator.oracle.github.com  3.5.16            Reconcile succeeded
----
