...
https://github.com/oracle/coherence-operator/releases/download/v3.1.5/coherence-operator-manifests.tar.gz[3.1.5 Manifests]
...
[source,bash]
----
cd ./manager && kustomize edit set image controller=container-registry.oracle.com/middleware/coherence-operator:3.1.5
----
...
[source,bash]
----
cd ./manager && kustomize edit add configmap env-vars --from-literal UTILS_IMAGE=container-registry.oracle.com/middleware/coherence-operator:3.1.5-utils
----
