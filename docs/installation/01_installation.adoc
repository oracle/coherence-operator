...
[source,bash]
----
kubectl apply -f https://github.com/oracle/coherence-operator/releases/download/v3.3.0/coherence-operator.yaml
----
...
https://github.com/oracle/coherence-operator/releases/download/v3.3.0/coherence-operator-manifests.tar.gz[3.3.0 Manifests]
...
[source,bash]
----
cd ./manager && kustomize edit set image controller=myregistry/coherence-operator:3.3.0
----
...
[source,bash]
----
cd ./manager && kustomize edit add configmap env-vars --from-literal OPERATOR_IMAGE=myregistry/coherence-operator:3.3.0
----
...
coherence-operator.oracle.github.com  Oracle Coherence Operator  A Kubernetes operator for managing Oracle Coherence clusters  3.3.0
----
...
coherence  coherence-operator.oracle.github.com  3.3.0            Reconcile succeeded
----
