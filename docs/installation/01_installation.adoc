...
[source,bash]
----
kubectl apply -f https://github.com/oracle/coherence-operator/releases/download/v3.2.12/coherence-operator.yaml
----
...
https://github.com/oracle/coherence-operator/releases/download/v3.2.12/coherence-operator-manifests.tar.gz[3.2.12 Manifests]
...
[source,bash]
----
cd ./manager && kustomize edit set image controller=myregistry/coherence-operator:3.2.12
----
...
[source,bash]
----
cd ./manager && kustomize edit add configmap env-vars --from-literal OPERATOR_IMAGE=myregistry/coherence-operator:3.2.12
----
...
coherence-operator.oracle.github.com  Oracle Coherence Operator  A Kubernetes operator for managing Oracle Coherence clusters  3.2.12
----
...
coherence  coherence-operator.oracle.github.com  3.2.12            Reconcile succeeded
----
