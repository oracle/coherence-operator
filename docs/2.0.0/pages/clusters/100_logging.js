...
<p>See the in-depth <router-link to="/logging/010_overview">logging guide</router-link> for more details on configuring application logging.</p>
...
<router-link to="#clusters/065_application_image.adoc" @click.native="this.scrollFix('#clusters/065_application_image.adoc')">application code</router-link> or by <router-link to="#clusters/150_volumes.adoc" @click.native="this.scrollFix('#clusters/150_volumes.adoc')">mounting a volume</router-link> containing
