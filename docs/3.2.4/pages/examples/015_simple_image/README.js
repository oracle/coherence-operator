...
<p ><p><img src="./images/GitHub-Mark-32px.png" alt="GitHub Mark 32px" />
 The complete source code for this example is in the <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/tree/master/examples/015_simple_image">Coherence Operator GitHub</a> repository.</p>
</p>
</div>
...
title="build.gradle"
>dependencies {
    implementation platform("com.oracle.coherence.ce:coherence-bom:21.06.2")</markup>
...
>&lt;plugin&gt;
    ...
    &lt;configuration&gt;
        &lt;from&gt;
            &lt;image&gt;gcr.io/distroless/java:11&lt;/image&gt;    <span class="conum" data-value="1" />
        &lt;/from&gt;
        &lt;to&gt;
...
<ul class="colist">
<li data-value="1">The base image will be <code>gcr.io/distroless/java:11</code></li>
...
>jib {
  from {
    image = 'gcr.io/distroless/java:11'    <span class="conum" data-value="1" />
  }
  to {
