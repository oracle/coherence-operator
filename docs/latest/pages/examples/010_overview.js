...
<h3 id="_3_autoscaling">3. Autoscaling</h3>
<div class="section">
<p>The Autoscaling example demonstrates how to use the Kubernetes
<a id="" title="" target="_blank" href="https://kubernetes.io/docs/tasks/run-application/horizontal-pod-autoscale/">Horizontal Pod Autoscaler</a>
to scale a Coherence cluster based on metrics. The example scales based on heap usage after GC.</p>

<p>Please see <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/tree/master/examples/autoscaler">GitHub</a> for full instructions.</p>
