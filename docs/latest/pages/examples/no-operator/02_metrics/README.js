...
<p ><p><img src="./images/GitHub-Mark-32px.png" alt="GitHub Mark 32px" />
 The complete source code for this example is in the <a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/tree/master/examples/no-operator/02_metrics">Coherence Operator GitHub</a> repository.</p>
</p>
</div>
...
>vendor:coherence_cluster_size{cluster="storage", version="21.06.2"} 3</markup>

<p>This displays the metric name in Prometheus format <code>vendor:coherence_cluster_size</code>, the metric labels <code>cluster="storage", version="21.06.2"</code> and the metric value, in this case <code>3</code> as there are three cluster members because we specified a replicas value of 3 in the <code>StatefulSet</code>.</p>
...
>[{"name":"Coherence.Cluster.Size","tags":{"cluster":"storage","version":"21.06.2"},"scope":"VENDOR","value":3}]</markup>
