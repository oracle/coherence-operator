...
* ConfigMaps - easily add a `ConfigMap` volume and volume mapping see: <<misc_pod_settings/050_configmap_volumes.adoc,Add ConfigMap Volumes>>
* Secrets - easily add a `Secret` volume and volume mapping see: <<misc_pod_settings/060_secret_volumes.adoc,Add Secret Volumes>>
* Volumes - easily add any additional volume and volume mapping see: <<misc_pod_settings/070_add_volumes.adoc,Add Volumes>>
