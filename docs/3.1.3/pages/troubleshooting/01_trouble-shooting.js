...
<ul class="ulist">
<li>
<p><router-link to="#stuck-pending" @click.native="this.scrollFix('#stuck-pending')">My Coherence cluster is stuck with pending Pods</router-link></p>
...
<h3 id="stuck-pending">My Coherence cluster is stuck with pending Pods</h3>
<div class="section">
