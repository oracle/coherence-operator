...
<dd slot="desc"><p>The Coherence Operator is available as a Docker image <code>oracle/coherence-operator:3.1.3</code> that can
...
<li>
<p>Access to a Kubernetes v1.13.0+ cluster. The Operator test pipeline runs on Kubernetes tested on v1.13 upto v1.19</p>
...
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.1.3/coherence-operator-manifests-3.1.3.tar.gz">3.1.3 Manifests</a></p>
...
<p>Download the
<a id="" title="" target="_blank" href="https://github.com/oracle/coherence-operator/releases/download/v3.1.3/coherence-operator-manifests-3.1.3.tar.gz">3.1.3 Manifests</a>
...
>cd ./manager &amp;&amp; kustomize edit set image controller=container-registry.oracle.com/middleware/coherence-operator:3.1.3</markup>
...
>cd ./manager &amp;&amp; kustomize edit add configmap env-vars --from-literal UTILS_IMAGE=container-registry.oracle.com/middleware/coherence-operator:3.1.3-utils</markup>
