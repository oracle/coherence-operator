...
<p>The required CRD can be installed with kubectl
For example, to install the CRD into a k8s v1.16.x or above cluster:</p>
...
<p>or to install the CRD into a k8s v1.15.x or below cluster:</p>

<markup
lang="bash"

>kubectl create -f crd-v1beta1/coherence.oracle.com_coherence.yaml</markup>
</p>
</div>
</div>
