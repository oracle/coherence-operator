...
<dd slot="desc"><p>The Coherence Operator is available as a Docker image <code>oracle/coherence-operator:3.1.1</code> that can
...
<div class="admonition note">
<p class="admonition-inline">All of the commands below are run from a console in the <code>manifests/</code> directory from the extracted file above.</p>
</div>
